...
public struct EndpointConfiguration: RequestConfigurationType {
    ...
    public init(pathConstructor: PathConstructor, method: HTTPMethod, requiresToken: Bool = true, allowsCaching: Bool = false, body: RequestBody? = nil, loginString: String? = nil) {
